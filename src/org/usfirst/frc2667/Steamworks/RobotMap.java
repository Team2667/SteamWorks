...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainRobotDriveCAN.setSensitivity(0.5);
        driveTrainRobotDriveCAN.setMaxOutput(1.0);
        ...
        ballCollectorCollectorController = new Talon(4);
        LiveWindow.addActuator("BallCollector", "CollectorController", (Talon) ballCollectorCollectorController);
